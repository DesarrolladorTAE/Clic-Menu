      ...
      <Stack spacing={3}>
        ...
        >
          <Stack spacing={1.25}>
            ...
            <InstructionRow
              step="2"
              text="Elige un producto compuesto, luego un componente que permita variantes y después una variante específica."
            />

            <InstructionRow
              step="3"
              text="Administra los grupos que estarán disponibles solo para esa variante del componente."
            />
          </Stack>
        </Paper>
        ...
        >
          <Stack spacing={1.25}>
            ...
            >
              {variantAllowedComponents.length === 0 ? (
                <MenuItem disabled value="">
        ...
        >
          <Stack spacing={1.25}>
            <Typography sx={fieldLabelSx}>Variante del componente</Typography>
            ...
            >
              {variants.length === 0 ? (
                ...
                variants.map((row) => (
                  <MenuItem key={row.variant.id} value={String(row.variant.id)}>
                    {row.variant.name}
                  </MenuItem>
                ))
              )}
        ...
        >
          ...
          >
            ...
            >
              Grupos asignados a la variante del componente
            </Typography>
          ...
          {!selectedProduct ? (
            ...
            <Box sx={{ px: 3, py: 5, textAlign: "center" }}>
              ...
              >
                Asigna tu primer grupo de modificadores a esta variante del componente.
              </Typography>
