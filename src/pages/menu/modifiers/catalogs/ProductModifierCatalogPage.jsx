...
import {
  Box, Button, Card, Chip, CircularProgress, FormControlLabel, IconButton, ListSubheader, MenuItem,
  Paper, Stack, Switch, Table, TableBody, TableCell, TableContainer, TableHead, TableRow,
  Tooltip, Typography, useMediaQuery, TextField,
} from "@mui/material";
      ...
      <Stack spacing={3}>
        ...
        >
          <Stack spacing={1.25}>
            ...
            <InstructionRow
              step="2"
              text="Filtra por categoría o por estado para ubicar más fácil el producto que quieres configurar."
            />

            <InstructionRow
              step="3"
              text="Después elige el producto y administra los grupos que tendrá disponibles."
            />
          </Stack>
        </Paper>
        ...
        >
          ...
          >
            ...
            <Button
              ...
              variant="contained"
              startIcon={<AddIcon />}
              disabled={!selectedProduct || availableGroups.length === 0}
              sx={{
          ...
          {!selectedProduct ? (
            ...
            >
              ...
              >
                Primero elige un producto para poder administrar su catálogo de modificadores.
              </Typography>
            </Box>
            ...
            >
              ...
              >
                Asigna tu primer grupo de modificadores a este producto.
              </Typography>
