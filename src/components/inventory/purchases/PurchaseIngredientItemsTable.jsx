...
export default function PurchaseIngredientItemsTable({
  items = [],
  editable = false,
  onAdd,
  onEdit,
  ...
  return (
    ...
    >
      ...
      {items.length === 0 ? (
        <EmptyText text="No hay ingredientes agregados en esta compra." />
      ) : isMobile ? (
        <Stack spacing={1.5} sx={{ p: 2 }}>
          {items.map((item) => (
            ...
            >
              <Box sx={{ p: 2 }}>
                <Stack spacing={1.25}>
                  <Info label="Ingrediente" value={item.ingredient?.name || "—"} />
                  <Info
                    label="Presentación"
                    value={item.presentation?.description || "—"}
                  />
        ...
        <TableContainer sx={{ width: "100%", overflowX: "hidden" }}>
          <Table sx={{ width: "100%", tableLayout: "fixed" }}>
            <TableHead>
              ...
              >
                <TableCell sx={{ width: "20%" }}>Ingrediente</TableCell>
                <TableCell sx={{ width: "24%" }}>Presentación</TableCell>
                <TableCell sx={{ width: "12%" }}>Cantidad</TableCell>
                <TableCell sx={{ width: "14%" }}>Costo unitario</TableCell>
                <TableCell sx={{ width: "14%" }}>Subtotal</TableCell>
