import {
  Box, Card, Chip, Paper, Stack, Table, TableBody, TableCell, TableContainer, TableHead,
    ...
    >
      ...
      {rows.length === 0 ? (
        <InventoryMovementEmptyState
          ...
          description="Todavía no existen movimientos manuales para productos con stock directo en este almacén."
                    ...
                    <Stack spacing={1.5} sx={{ height: "100%" }}>
                      ...
                      >
                        <Box sx={{ minWidth: 0 }}>
                          ...
                          >
                            {row.product?.category_name || "Sin categoría"}
                          </Typography>
                        </Box>
                      ...
                      <InfoBlock label="Cantidad" value={String(row.quantity)} />
                      <InfoBlock
