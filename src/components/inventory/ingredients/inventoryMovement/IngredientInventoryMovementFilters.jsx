import {
  FormControl, MenuItem, Paper, Select, Stack, TextField, Typography,
} from "@mui/material";
...
export default function IngredientInventoryMovementFilters({
  ingredientId,
    ...
    >
      <Stack spacing={2}>
        ...
        >
          <BoxField
            label="Ingrediente"
            helper="Filtra por ingrediente."
            sx={{ flex: 1 }}
          >
            <FormControl fullWidth>
              <Select
                value={ingredientId}
                onChange={(e) => onChangeIngredientId(e.target.value)}
                displayEmpty
                IconComponent={KeyboardArrowDownIcon}
              >
                <MenuItem value="">Todos los ingredientes</MenuItem>
