...
const features = [
  ...
  {
    title: "Administra tu catálogo con mayor control",
    text: "Organiza productos, categorías, precios e imágenes desde un espacio diseñado para mantener tu información actualizada.",
  ...
  },
  {
    ...
    text: "Consulta ventas y métricas operativas para hacer crecer tu restaurante.",
    chips: ["Ventas",  "Reportes", "Excel y PDF"],
  ...
  },
  {
    ...
    chips: ["WhatsApp", "Tickets digitales", "Programa de puntos"],
