...
export default function CashierPaymentTabs({ value = "payment", onChange }) {
  ...
  return (
    ...
    >
      ...
      >
        <Tab value="payment" label="Cobro" disableRipple sx={tabSx} />
        <Tab value="tools" label="Herramientas" disableRipple sx={tabSx} />
      </Tabs>
    </Box>
  );
}
