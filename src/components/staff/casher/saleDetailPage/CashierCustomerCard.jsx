// src/components/staff/casher/saleDetailPage/CashierCustomerCard.jsx
...
export default function CashierCustomerCard({
  ...
  const [activeMode, setActiveMode] = useState("ticket");
      ...
      <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
        <Stack spacing={2.5}>
          <Box>
            ...
            >
              Guarda contacto simple para ticket o asocia una cuenta formal para
              historial y puntos.
            </Typography>
          </Box>
          ...
          >
            ...
            >
              <ModeButton
                active={activeMode === "ticket"}
                icon={<ConfirmationNumberRoundedIcon />}
                title="Cliente ticket"
                subtitle="Contacto simple"
                onClick={() => setActiveMode("ticket")}
              />

              <ModeButton
                active={activeMode === "points"}
                icon={<StarsRoundedIcon />}
                title="Cuenta para puntos"
                subtitle="Cliente formal"
...
function ModeButton({ active, icon, title, subtitle, onClick }) {
  return (
    <Button
      type="button"
      onClick={onClick}
      ...
      sx={{
        ...
        "&:hover": {
          borderColor: "#F57C00",
          bgcolor: active ? "#F57C00" : "rgba(255, 152, 0, 0.06)",
        },
      }}
    >
