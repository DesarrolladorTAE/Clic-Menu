...
export default function CashierOnlineOrdersTabs({
  tab,
  onChange,
  availableCount = 0,
  myCount = 0,
  ...
  return (
    ...
    >
      ...
      >
        <Tab value="available" label={`Disponibles (${availableCount})`} disableRipple sx={tabSx} />
        <Tab value="mine" label={`Mis pedidos (${myCount})`} disableRipple sx={tabSx} />
      </Tabs>
    </Box>
  );
}
