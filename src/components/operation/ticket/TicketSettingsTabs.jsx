...
export default function TicketSettingsTabs({ value = "ticket", onChange }) {
  ...
  return (
    ...
    >
      ...
      >
        <Tab value="ticket" label="Ticket" disableRipple sx={tabSx} />
        <Tab value="print" label="Impresión térmica" disableRipple sx={tabSx} />
      </Tabs>
    </Box>
  );
}